...
ตอบ: สำหรับบริการแบบโฮสต์ API key แต่ละรายการรันคำขอพร้อมกันได้จำนวนจำกัดตาม[แพ็กเกจ](https://anycrawl.dev/price)ของคุณ คำขอที่เกินขีดจำกัดจะได้รับ `429 Concurrency limit reached` ทันที — ลองใหม่เมื่อคำขอที่กำลังทำงานอยู่เสร็จสิ้น ส่วนการติดตั้งแบบ self-hosted ไม่มีขีดจำกัด concurrency โดยค่าเริ่มต้น
