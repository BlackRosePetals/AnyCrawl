...
เฉพาะบริการแบบโฮสต์เท่านั้น คืนค่าเมื่อ `scrape_options` ขอใช้ฟีเจอร์ที่แพ็กเกจของคุณไม่รวมไว้ — ปัจจุบันคือ `proxy: "stealth"` ซึ่งต้องใช้แพ็กเกจ Hobby ขึ้นไป
...
API ประมวลผลคำขอค้นหาพร้อมกันแบบขนาน
...
- **Concurrency:** สำหรับบริการแบบโฮสต์ จำนวนคำขอที่ API key หนึ่งรันพร้อมกันได้ขึ้นอยู่กับ[แพ็กเกจ](https://anycrawl.dev/price)ของคุณ คำขอที่เกินจะได้รับ `429` ส่วนการติดตั้งแบบ self-hosted ไม่มีขีดจำกัดโดยค่าเริ่มต้น
